...
class S3Control {
  ...
  Future<DescribeMultiRegionAccessPointOperationResult>
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/v20180820/async-requests/mrap/${requestTokenARN.split('/').map((e) => Uri.encodeComponent(e)..replaceAll('+', '%20')).join('/')}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<GetMultiRegionAccessPointResult> getMultiRegionAccessPoint({
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/v20180820/mrap/instances/${name.split('/').map((e) => Uri.encodeComponent(e)..replaceAll('+', '%20')).join('/')}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<GetMultiRegionAccessPointPolicyResult>
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/v20180820/mrap/instances/${name.split('/').map((e) => Uri.encodeComponent(e)..replaceAll('+', '%20')).join('/')}/policy',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<GetMultiRegionAccessPointPolicyStatusResult>
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/v20180820/mrap/instances/${name.split('/').map((e) => Uri.encodeComponent(e)..replaceAll('+', '%20')).join('/')}/policystatus',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<GetMultiRegionAccessPointRoutesResult>
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/v20180820/mrap/instances/${mrap.split('/').map((e) => Uri.encodeComponent(e)..replaceAll('+', '%20')).join('/')}/routes',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
