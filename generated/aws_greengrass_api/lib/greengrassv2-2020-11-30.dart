...
class GreengrassV2 {
  ...
  Future<GetComponentVersionArtifactResponse> getComponentVersionArtifact({
    ...
    final response = await _protocol.send(
      ...
      method: 'GET',
      requestUri:
          '/greengrass/v2/components/%24%7BUri.encodeQueryComponent%28arn%29.replaceAll%28%27%2B%27%2C%20%27%2520%27%29%7D/artifacts/${artifactName.split('/').map((e) => Uri.encodeComponent(e)..replaceAll('+', '%20')).join('/')}',
      exceptionFnMap: _exceptionFns,
    );
