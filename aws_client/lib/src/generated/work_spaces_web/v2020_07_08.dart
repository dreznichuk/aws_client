...
class WorkSpacesWeb {
  ...
  ///
  /// <code>IAM_Identity_Center</code> web portals are authenticated through AWS
  /// IAM Identity Center (successor to AWS Single Sign-On). They provide
  /// additional features, such as IdP-initiated authentication. Identity
  /// sources (including external identity provider integration), plus user and
...
class Portal {
  ...
  /// <code>IAM_Identity_Center</code> web portals are authenticated through AWS
  /// IAM Identity Center (successor to AWS Single Sign-On). They provide
  /// additional features, such as IdP-initiated authentication. Identity sources
  /// (including external identity provider integration), plus user and group
