...
class CloudFront {
  ...
  Future<CreateInvalidationResult> createInvalidation2017_03_25({
    ...
    final $result = await _protocol.sendRaw(
      method: 'POST',
      requestUri:
          '/2017-03-25/distribution/${Uri.encodeQueryComponent(distributionId).replaceAll('+', '%20')}/invalidation',
  ...
  Future<void> deleteCloudFrontOriginAccessIdentity2017_03_25({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2017-03-25/origin-access-identity/cloudfront/${Uri.encodeQueryComponent(id).replaceAll('+', '%20')}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<void> deleteDistribution2017_03_25({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2017-03-25/distribution/${Uri.encodeQueryComponent(id).replaceAll('+', '%20')}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<void> deleteServiceLinkedRole2017_03_25({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2017-03-25/service-linked-role/${Uri.encodeQueryComponent(roleName).replaceAll('+', '%20')}',
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<void> deleteStreamingDistribution2017_03_25({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2017-03-25/streaming-distribution/${Uri.encodeQueryComponent(id).replaceAll('+', '%20')}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<GetCloudFrontOriginAccessIdentityConfigResult>
    ...
    final $result = await _protocol.sendRaw(
      method: 'GET',
      requestUri:
          '/2017-03-25/origin-access-identity/cloudfront/${Uri.encodeQueryComponent(id).replaceAll('+', '%20')}/config',
      exceptionFnMap: _exceptionFns,
    );
    final $elem = await _s.xmlFromResponse($result);
  ...
  Future<GetDistributionConfigResult> getDistributionConfig2017_03_25({
    ...
    final $result = await _protocol.sendRaw(
      method: 'GET',
      requestUri:
          '/2017-03-25/distribution/${Uri.encodeQueryComponent(id).replaceAll('+', '%20')}/config',
      exceptionFnMap: _exceptionFns,
    );
    final $elem = await _s.xmlFromResponse($result);
  ...
  Future<GetInvalidationResult> getInvalidation2017_03_25({
    ...
    final $result = await _protocol.sendRaw(
      method: 'GET',
      requestUri:
          '/2017-03-25/distribution/%24%7BUri.encodeQueryComponent%28distributionId%29.replaceAll%28%27%2B%27%2C%20%27%2520%27%29%7D/invalidation/${Uri.encodeQueryComponent(id).replaceAll('+', '%20')}',
      exceptionFnMap: _exceptionFns,
    );
    final $elem = await _s.xmlFromResponse($result);
  ...
  Future<GetStreamingDistributionConfigResult>
    ...
    final $result = await _protocol.sendRaw(
      method: 'GET',
      requestUri:
          '/2017-03-25/streaming-distribution/${Uri.encodeQueryComponent(id).replaceAll('+', '%20')}/config',
      exceptionFnMap: _exceptionFns,
    );
    final $elem = await _s.xmlFromResponse($result);
  ...
  Future<ListDistributionsByWebACLIdResult>
    ...
    final $result = await _protocol.sendRaw(
      method: 'GET',
      requestUri:
          '/2017-03-25/distributionsByWebACLId/${Uri.encodeQueryComponent(webACLId).replaceAll('+', '%20')}',
      queryParams: $query,
      exceptionFnMap: _exceptionFns,
    );
    final $elem = await _s.xmlFromResponse($result);
