...
class LexRuntimeV2 {
  ...
  Future<DeleteSessionResponse> deleteSession({
    ...
    final response = await _protocol.send(
      ...
      method: 'DELETE',
      requestUri:
          '/bots/${Uri.encodeQueryComponent(botId).replaceAll('+', '%20')}/botAliases/${Uri.encodeQueryComponent(botAliasId).replaceAll('+', '%20')}/botLocales/${Uri.encodeQueryComponent(localeId).replaceAll('+', '%20')}/sessions/${Uri.encodeQueryComponent(sessionId).replaceAll('+', '%20')}',
  ...
  Future<RecognizeTextResponse> recognizeText({
    ...
    final response = await _protocol.send(
      ...
      method: 'POST',
      requestUri:
          '/bots/${Uri.encodeQueryComponent(botId).replaceAll('+', '%20')}/botAliases/${Uri.encodeQueryComponent(botAliasId).replaceAll('+', '%20')}/botLocales/${Uri.encodeQueryComponent(localeId).replaceAll('+', '%20')}/sessions/${Uri.encodeQueryComponent(sessionId).replaceAll('+', '%20')}/text',
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<RecognizeUtteranceResponse> recognizeUtterance({
    ...
    final response = await _protocol.sendRaw(
      ...
      method: 'POST',
      requestUri:
          '/bots/${Uri.encodeQueryComponent(botId).replaceAll('+', '%20')}/botAliases/${Uri.encodeQueryComponent(botAliasId).replaceAll('+', '%20')}/botLocales/${Uri.encodeQueryComponent(localeId).replaceAll('+', '%20')}/sessions/${Uri.encodeQueryComponent(sessionId).replaceAll('+', '%20')}/utterance',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
