...
class Route53 {
  ...
  Future<ActivateKeySigningKeyResponse> activateKeySigningKey({
    ...
    final $result = await _protocol.send(
      method: 'POST',
      requestUri:
          '/2013-04-01/keysigningkey/${Uri.encodeQueryComponent(hostedZoneId).replaceAll('+', '%20')}/${Uri.encodeQueryComponent(name).replaceAll('+', '%20')}/activate',
  ...
  Future<void> changeTagsForResource({
    ...
    await _protocol.send(
      method: 'POST',
      requestUri:
          '/2013-04-01/tags/${Uri.encodeQueryComponent(resourceType.toValue()).replaceAll('+', '%20')}/${Uri.encodeQueryComponent(resourceId).replaceAll('+', '%20')}',
  ...
  Future<DeactivateKeySigningKeyResponse> deactivateKeySigningKey({
    ...
    final $result = await _protocol.send(
      method: 'POST',
      requestUri:
          '/2013-04-01/keysigningkey/${Uri.encodeQueryComponent(hostedZoneId).replaceAll('+', '%20')}/${Uri.encodeQueryComponent(name).replaceAll('+', '%20')}/deactivate',
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<DeleteKeySigningKeyResponse> deleteKeySigningKey({
    ...
    final $result = await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2013-04-01/keysigningkey/${Uri.encodeQueryComponent(hostedZoneId).replaceAll('+', '%20')}/${Uri.encodeQueryComponent(name).replaceAll('+', '%20')}',
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<void> deleteTrafficPolicy({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2013-04-01/trafficpolicy/${Uri.encodeQueryComponent(id).replaceAll('+', '%20')}/${Uri.encodeQueryComponent(version.toString()).replaceAll('+', '%20')}',
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<GetHostedZoneLimitResponse> getHostedZoneLimit({
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/2013-04-01/hostedzonelimit/${Uri.encodeQueryComponent(hostedZoneId).replaceAll('+', '%20')}/${Uri.encodeQueryComponent(type.toValue()).replaceAll('+', '%20')}',
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<GetReusableDelegationSetLimitResponse> getReusableDelegationSetLimit({
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/2013-04-01/reusabledelegationsetlimit/${Uri.encodeQueryComponent(delegationSetId).replaceAll('+', '%20')}/${Uri.encodeQueryComponent(type.toValue()).replaceAll('+', '%20')}',
      exceptionFnMap: _exceptionFns,
    );
